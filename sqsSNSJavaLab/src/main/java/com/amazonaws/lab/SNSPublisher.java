...
public class SNSPublisher {
	...
	private static final String TOPIC_ARN_EMAIL = "arn:aws:sns:us-west-2:934542718881:EmailSNSTopic";

	// TODO 2: Set ARN for SNS topic for order messages
	private static final String TOPIC_ARN_ORDER = "arn:aws:sns:us-west-2:934542718881:OrderSNSTopic";
...
//		Solution.publishOrder(snsClient, TOPIC_ARN_ORDER, jsonOrder);
		snsClient.publish(TOPIC_ARN_ORDER, jsonOrder);
	}
}
